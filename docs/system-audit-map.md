...
| Arquivo | Conteudo |
| --- | --- |
| `docs/full-system-audit.md` | Relatorio executivo e tecnico completo |
| `docs/stock-consistency-report.md` | Comparacao saldo vs movimentos |
| `docs/model-db-diff.md` | Diff automatico models SQLAlchemy vs Supabase |
| `docs/audit-prompt-completion-checklist.md` | Fechamento literal do prompt, item por item |
| `docs/audit-fix-plan.md` | Plano de correcao por fases |
